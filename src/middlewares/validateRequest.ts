...
//           (!Array.isArray(req.files) &&
//             req.files?.business_document &&
//             req.files.business_document.length > 0 &&
//             req.files.business_document?.map((doc: any) => doc.path)) ||
//           [];
//         const workplace_image =
//           (!Array.isArray(req.files) &&
//             req.files?.workplace_image &&
//             req.files.workplace_image.length > 0 &&
//             req.files.workplace_image?.map((doc: any) => doc.path)) ||
//           [];
//         const nid_image =
//           (!Array.isArray(req.files) &&
//             req.files?.nid_image &&
//             req.files.nid_image.length > 0 &&
//             req.files.nid_image?.map((doc: any) => doc.path)) ||
//           [];
